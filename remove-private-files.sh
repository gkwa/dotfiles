...
java -jar $bfgjar --delete-files '{kee.kdb,notes.txt,.alias,unzip.exe}' --delete-folders '{.info,emacs,notes}' /tmp/dotfiles.git
# java -jar $bfgjar --strip-blobs-bigger-than 1M /tmp/dotfiles.git
cd /tmp/dotfiles.git
