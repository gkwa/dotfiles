	  ...
	  (if (looking-at "^\\\\")
		...
		(if (looking-at "^ *//10.0.2.218")
		    (progn
		      ...
		      (replace-string "//10.0.2.218" "http://dl.dropbox.com/u/9140609") ;; taylor's public dropbox folder
		      )
...
(custom-set-variables
 ...
 '(debug-ignored-errors
   (quote
	("^Invalid face:? " "^No window numbered .$" "^Eldoc needs an inferior Python process running." "^Completion needs an inferior Python process running." "^Can't shift all lines enough" beginning-of-line beginning-of-buffer end-of-line end-of-buffer end-of-file buffer-read-only file-supersession)))
 '(delete-by-moving-to-trash t)
 '(diary-file (expand-file-name "~/.diary"))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(helm-selection ((t (:background "black" :foreground "magenta")))))
